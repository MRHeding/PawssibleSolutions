    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div class="grid grid-cols-3 md:grid-cols-5 gap-4">
            ...
            <a href="medical_records.php" class="bg-teal-50 hover:bg-teal-100 p-4 rounded-lg text-center transition">
                ...
                <span class="block text-gray-800 font-medium">Medical Records</span>
            </a>
            ...
            <a href="reports.php" class="bg-indigo-50 hover:bg-indigo-100 p-4 rounded-lg text-center transition">
                <svg class="w-8 h-8 text-indigo-600 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                </svg>
                <span class="block text-gray-800 font-medium">Reports</span>
            </a>
            ...
            <a href="pets.php" class="bg-orange-50 hover:bg-orange-100 p-4 rounded-lg text-center transition">
                <svg class="w-8 h-8 text-orange-600 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path>
                </svg>
                <span class="block text-gray-800 font-medium">Pet Registry</span>
            </a>
        </div>
    </div>
