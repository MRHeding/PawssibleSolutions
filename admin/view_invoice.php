...
<div class="bg-gradient-to-r from-violet-600 to-violet-700 py-10">
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-white">View Invoice</h1>
                <p class="text-white text-opacity-90 mt-2">Invoice #INV-<?php echo str_pad($invoice['id'], 4, '0', STR_PAD_LEFT); ?></p>
            </div>
            <div class="flex space-x-3">
                <?php if (!$invoice['paid']): ?>
                    <a href="record_payment.php?id=<?php echo $invoice_id; ?>" class="bg-white hover:bg-gray-100 text-green-600 font-bold py-2 px-4 rounded inline-flex items-center transition">
                        <i class="fas fa-dollar-sign mr-2"></i> Record Payment
                    </a>
                <?php endif; ?>
                <a href="print_invoice.php?id=<?php echo $invoice_id; ?>" target="_blank" class="bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-2 px-4 rounded inline-flex items-center transition">
                    <i class="fas fa-print mr-2"></i> Print/PDF
                </a>
                <a href="payments.php" class="bg-white bg-opacity-20 hover:bg-opacity-30 text-white font-bold py-2 px-4 rounded inline-flex items-center transition">
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mt-8 flex justify-center space-x-4">
        <?php if (!$invoice['paid']): ?>
            <a href="record_payment.php?id=<?php echo $invoice_id; ?>" class="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg inline-flex items-center transition">
                <i class="fas fa-dollar-sign mr-2"></i> Record Payment
            </a>
        <?php endif; ?>
        <a href="edit_invoice.php?id=<?php echo $invoice_id; ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg inline-flex items-center transition">
            <i class="fas fa-edit mr-2"></i> Edit Invoice
        </a>
        <button onclick="window.print()" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-lg inline-flex items-center transition">
            <i class="fas fa-print mr-2"></i> Print Invoice
        </button>
        <a href="payments.php" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-3 px-6 rounded-lg inline-flex items-center transition">
            <i class="fas fa-list mr-2"></i> Back to Payments
        </a>
    </div>
</div>
