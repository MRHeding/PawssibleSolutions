...
<div class="bg-white rounded-lg shadow-md p-6">
    <h3 class="text-lg font-semibold text-gray-800 mb-4">Export Revenue Report</h3>
    <div class="flex flex-wrap gap-4">
        <a href="export_csv_report.php?report_type=revenue&date_from=<?php echo $date_from; ?>&date_to=<?php echo $date_to; ?>" 
           class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded text-sm">
            <i class="fas fa-file-csv mr-2"></i>Export to CSV
        </a>
        <a href="export_pdf_report.php?report_type=revenue&date_from=<?php echo $date_from; ?>&date_to=<?php echo $date_to; ?>" 
